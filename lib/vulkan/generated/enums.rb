...
module Vulkan
  ...
  typealias "VkGeometryFlagBitsNVX", 'int'
  typealias "VkGeometryInstanceFlagBitsNVX", 'int'
  typealias "VkBuildAccelerationStructureFlagBitsNVX", 'int'
  typealias "VkCopyAccelerationStructureModeNVX", 'int'
  typealias "VkAccelerationStructureTypeNVX", 'int'
  typealias "VkGeometryTypeNVX", 'int'
